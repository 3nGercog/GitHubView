        ...
        <fieldset style="width: 50%; text-align: center">
            ...
            <ol class="login">
                <li>
                    ...
                    <asp:RequiredFieldValidator ErrorMessage="Поле login обязательное для заполнения" ControlToValidate="text" runat="server" />
                </li>
                <li>
                    <asp:Label CssClass="user" Text="Password" runat="server" />
                    <br /><input type="password" runat="server" id="password" name="" style="width: 30%" />
                    <asp:RequiredFieldValidator ErrorMessage="Поле password обязательное для заполнения" ControlToValidate="password" runat="server" />
                </li>
            </ol>
